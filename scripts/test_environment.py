...
def test_environment():
    ...
    print("3. Implement your reward function")
    ...
    print("      current_player = env.game.current_player_index")
    print("      obs = observations[current_player]")
    print("      ")
    print("      # Your AI chooses action")
    print("      action = your_ai.choose_action(obs)")
    print("      params = your_ai.choose_params(action, obs)")
    print("      ")
    print("      # Execute action")
    print("      obs, done, info = env.step(current_player, action, params)")
    print("      ")
    print("      # Calculate YOUR reward")
    print("      reward = your_reward_function(obs, info)")
    print("      ")
    print("      # Learn")
    print("      your_ai.learn(obs, action, reward)")
    print("="*60)
