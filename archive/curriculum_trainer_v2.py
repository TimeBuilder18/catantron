"""
Curriculum Training using Full CatanEnv

Uses your existing reward system (PBRS, VP rewards, etc.) from catan_env_pytorch.py
"""
...
def play_random_turn(game, player_id):
    """Weak opponent - random legal moves"""
...
class CurriculumTrainerV2:
    """Uses full CatanEnv with your existing reward system"""
    ...
    def train(self, games_per_phase=300, parallel_games=8, save_path='models/curriculum_v2'):
        ...
        print("\n" + "=" * 70)
        print("CURRICULUM TRAINING V2 (Using Full Reward System)")
        print("=" * 70)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--games-per-phase', type=int, default=300)
